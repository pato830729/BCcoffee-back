...
export const createOrder = async (req, res) => {
  try {
    ...
    // 建立訂單
    result = await orders.create({ u_id: req.user._id, products: req.user.cart, name: req.body.name, address: req.body.address, phone: req.body.phone, payway: req.body.payway })
    // 清空購物車
    req.user.cart = []
    await req.user.save()
